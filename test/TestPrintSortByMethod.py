...
class TestPrintSortedByMethod(unittest.TestCase):
    ...
    def test_outherFeature(self):
        ...
        with mock.patch('sys.stdout', new=io.StringIO()) as fake_stdout:
            printSortBy(post_data, ["age", "height"], reverse=False)
        
        assert fake_stdout.getvalue() == "Post op by age and throw:\ndd36dd00-ca2f-4e46-816a-aa4c14f3a40b 22 55.0\n4776da07-75e0-45ef-b9ce-6fb83169b074 22 80.0\n02afc5d1-9129-46c8-812b-63f9cf408399 33 65.0\n801408de-c828-49b2-bdf4-da51fee5cc89 58 25.0\n"
